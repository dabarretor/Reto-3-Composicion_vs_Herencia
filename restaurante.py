...
class Order:
    ...
    def apply_discount(self):
        ...
        if asked_drink and asked_principal_dishes and asked_desserts and \
        asked_additional_dishes:
...
if __name__ == "__main__":
    ...
    print(f"Discount applied: ${round(table_1.total_price() - table_1.apply_discount(), 2)}") # Output: 1.8
    print(f"Total to pay (with discount applied): ${round(table_1.apply_discount(), 2)}") # Output: 16.2
    print("-"*35)
